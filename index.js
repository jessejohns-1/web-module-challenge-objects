...
export const burger = {
  ...
  price: 18,
  category: "Lunch",
  discount: function (dog) {
    if ("teacher" === dog || "student" === dog) {
...
const reviews = [
  ...
  {
    name: "latoina jackson",
    rating: 1,
    feedback: "was pre sad sadboy much love though dang",
  },
];
...
reviews.push({
  ...
  rating: 5,
  feedback:
    "This was the most amazing stuff ever i enjoyed it thank you so much",
});
console.log(reviews);
/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 5: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 
